...
You can read the presentation for this tutorial by clicking on: <a href="https://r-inthelab.net/2021/02/08/simple-linear-regression-applied-to-enzyme-kinetics/" target="_blank">Simple Linear Regression Applied to Enzyme Kinetics</a>.
